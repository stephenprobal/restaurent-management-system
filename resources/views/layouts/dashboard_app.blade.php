...
<html lang="en">
  <head>
    ...
    <title>@yield('title','Restaurent Management System')</title>
    ...
    <link rel="icon" href="https://thumbs.dreamstime.com/b/food-spoon-fork-vector-symbol-graphic-logo-design-template-food-spoon-fork-symbol-logo-design-121549456.jpg" type="image/png" sizes="16x16"> 
    <!-- Starlight CSS -->
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        {{-- <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a class="nav-link">Breakfast Category</a></li>
          <li class="nav-item"><a href="map-vector.html" class="nav-link">Lunch Category</a></li>
          <li class="nav-item"><a href="map-vector.html" class="nav-link">Dinner Category</a></li>
          <li class="nav-item"><a href="map-vector.html" class="nav-link">Drink's Category</a></li>
          <li class="nav-item"><a href="map-vector.html" class="nav-link">Buffet Category</a></li>
          <li class="nav-item"><a href="map-vector.html" class="nav-link">Take Away Category</a></li>
        </ul> --}}
        <a href="{{ url('profile') }}" class="sl-menu-link @yield('profile')">
          <div class="sl-menu-item">
        ...
        <a href="{{ route('contactview') }}" class="sl-menu-link @yield('contact')">
          <div class="sl-menu-item">
        ...
        <a href="{{ route('newsleetter.index') }}" class="sl-menu-link" @yield('newsleetter')>
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
              ...
              <ul class="list-unstyled user-profile-nav">
                ...
                <li>
                  ...
                  onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i class="icon ion-power"></i> {{ __('Sign Out') }}</a></li>
